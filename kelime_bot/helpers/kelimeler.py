...
kelimeler = ["gözəl ","bilik","problem","təmin","ayrılmaq","zaman","susamaq","edin","istifadə","yox","bax",
              ...
              "yeni", "əsəb", "soruşmaq", "döyüşmək", "yandırmaq", 'eşitmək', 'ikisi', "həmişə", "səsli", "İnanmaq", "yoxlamaq", "saat", "necə",
              'bir', 'və', 'olmaq', 'bu', 'üçün', 'nəfəs', 'mən', 'demək', 'inək', 'vətən', 'nəsil', 'bəyənmək', 'döymək', 'almaq',
              'dəyərli', 'peşman', 'gülmək', 'birlikdə', 'vermək', 'amma', 'sonra', 'qədər', 'yer', 'çoxluq', 'insanlar', 'bizim', 'hər ', 'istəmək', 'il', 'çıxmaq', 'görmək', 'gün', 'biz', 'getmək', 'işləmək', 'şey', 'oxşamaq', 'bilmək', 'sənətkar', 'zaman',
              ...
              'sevmək', 'bir', 'çətin', 'almaq', 'itirmək', 'qoymaq', 'bir', 'kimsə', 'birlikdə', 'veriləcək', 'kimsə', 'bayraq', 'gənc',
              ...
              'divar', 'onun', 'incəsənət', 'haqda', 'xəstəlik', 'tələbə', 'televiziya', 'metod', 'masa', 'ölüm', 'komanda', 'top',
              ...
              'kifayət', 'doldurmaq', 'bəzi', 'şərt', 'qonşu', 'kişilik', 'telegram', 'İSTEHSAL', 'üstündə', 'tutmaq', 'nazik',
              ...
              'izləmək', 'birdən', 'tutmaq', 'saymaq', 'toplamaq', 'ütmək', 'qışqırmaq', 'məsuliyyət', 'hərəkət', 'dava',
              ...
              'vergi', 'rəy', 'qardaş', 'mətbuat', 'dəstək', 'geyinmək', 'səhv', 'limit', 'birlik', 'iş', 'görüşmək', 'yarım', 'yetər', 'fərdi', 'qaranlıq', 'avtobus', 'saniyə', 'körpə', 'vətəndaş', 'nazir', 'zaman', 'millət',
              'reklam', 'yüksəlmə', 'ölçü', 'cola', 'fanta', 'sosial', 'kimsə', 'keçmiş', 'xəstəxana', 'varlıq',
              'görüş', 'jurnalist', 'daxili', 'xəbərsız', 'keyfiyyət', 'bitdi', 'bitiş', 'yerləşin', 'giriş', 'rahat',
              ...
              'topla', 'investisiya', 'işıqlandırmaq', 'qarışdırmaq', 'təhlükə', 'zaman', 'dairə', 'imkan', 'informasiya', 'qarışdırmaq'
              ...
              'ətrafında', 'tezliklə', 'tərəvəz', 'orqan', 'öldürmək', 'başqa', 'il', 'qırmaq', 'baxmaq', 'meyvə', 'asmaq',
